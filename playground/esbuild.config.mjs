...
await cp(join(rootDir, 'fixtures', 'sql', 'simple_blog.sql'), join(examplesDir, 'simple_blog.sql'));
await cp(join(rootDir, 'fixtures', 'sql', 'ecommerce.sql'), join(examplesDir, 'ecommerce.sql'));
await cp(
