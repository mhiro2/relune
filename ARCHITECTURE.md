...
- The public GitHub Pages schema workbench is a thin static client over `relune-wasm`; it must not fork rendering, inspect, export, lint, or diff logic from the CLI path.
