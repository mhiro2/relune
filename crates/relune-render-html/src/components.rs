...
pub(crate) fn build_viewer_controls_html() -> String {
    ...
    <button type="button" class="viewer-control-button viewer-control-minimap" id="minimap-toggle" aria-pressed="true" aria-label="Toggle minimap" aria-controls="minimap-shell" title="Toggle minimap (M)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6l6-2 6 2 6-2v14l-6 2-6-2-6 2z"/><path d="M9 4v16M15 6v16"/></svg></button>
  </div>
