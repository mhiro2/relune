...
Relune is a schema review tool for the moments that hurt — dropped tables and
columns, broken references, narrowing types, `NOT NULL` on existing rows,
indexes lost in a rewrite — and still gives you a diagram, a diff, and a lint
pass when you need them.
